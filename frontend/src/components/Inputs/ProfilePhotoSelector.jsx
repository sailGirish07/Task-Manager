...
//           <button
//             type="button"
//             className="w-6 h-6 flex items-center justify-center bg-red-500 text-white rounded-full absolute top-1 right-1 z-10 transition-opacity duration-200 shadow-lg border border-white"
