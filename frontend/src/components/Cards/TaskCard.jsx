...
export default function TaskCard({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="flex items-end gap-3 px-3 flex-wrap">
        <div
      ...
      >
        <p className="text-sm font-medium text-gray-800 mt-4 line-column-2">
          {title}
        </p>
      ...
      <div className="px-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 my-1">
          <div>
