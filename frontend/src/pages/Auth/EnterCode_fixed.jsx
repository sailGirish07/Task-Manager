    ...
    <AuthLayout>
      <div className="lg:w-[70%] h-3/4 md:h-full flex flex-col justify-center">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between mb-6">
            {code.map((digit, index) => (
              <input
                ...
                className={`w-12 h-12 text-center text-xl border-2 rounded-lg focus:outline-none border-gray-300 focus:border-primary`}
                disabled={false}
              />
            ))}
          </div>
          ...
          {message && <p className="text-green-500 text-xs pb-2.5 text-center">{message}</p>}
