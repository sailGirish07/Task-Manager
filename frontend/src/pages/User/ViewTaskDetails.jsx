...
const TodoChecklist = ({ text, isChecked, onChange }) => {
  return (
    <div className="flex items-center ap-3 p-3">
      <input
        type="checkbox"
        checked={isChecked}
        onChange={onChange}
...
const Attachment = ({ link, index, onClick }) => {
  return (
    <div className="flex justify-between bg-gray-50 border border-gray-100 px-3 py-2 rounded-md mb-2 mt-2 cursor-pointer" onClick={onClick}>
